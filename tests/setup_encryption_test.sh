...
# This script sets up the encryption test script before test execution
...
echo "Copying test files to ${WEB_SERVER_HOST}:${WEB_SERVER_TARGET_DIR}/..."
scp -i ${SRE_SSH_KEY} -r "${PROJECT_HOME}/tests/"*.php "${SRE_USER}@${WEB_SERVER_HOST}:${WEB_SERVER_TARGET_DIR}/"
